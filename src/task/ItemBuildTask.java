...
public class ItemBuildTask extends Task {
	...
	/**
	 * This method, as all the others, decrements the needs of the {@link Drone}
	 * and adds the {@link Items} to the {@link Drone}. If not in the correct
	 * location, it is assigned a new {@link MoveTask}.
	 * 
	 * @param map
